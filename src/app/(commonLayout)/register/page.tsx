...
export default function RegisterPage() {
  ...
  return (
    <AuthShell
      title="Start writing"
      copy="Create your account and publish ideas that matter."
    >
      ...
      <p className="mt-6 text-center text-sm text-muted-foreground">
        ...
        <Link className="font-bold text-foreground" href="/login">
          Sign in
        </Link>
      </p>
    </AuthShell>
